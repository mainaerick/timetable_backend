...
<body>
    ...
    <form id="form_dep" class="w-100 p-7 border" style="padding: 5%; margin-bottom: 5%; margin-top: 2%;" action="../process/process.php" method="POST">
        ...
        <div style="margin-bottom: 3px;" class="row justify-content-end">
            ...
            <a class="btn btn-outline-secondary btn-sm" href="../department/department.php?hide_dep_add" role="group" aria-label="Third group">Close</a>
        ...
        <div class="form-group row">
            ...
            <input type="text" class="col-sm-8 form-control form-control-sm" id="depname" name="department_name" value="<?php echo $editdep_name; ?>" placeholder="name of the department" required>

        </div>
        <div class="form-group row">
            <label class="col-sm-4" for="coursename">School Name</label>
